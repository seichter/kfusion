...
MSKinectDevice1::MSKinectDevice1() : RGBD(), gotDepth(false), die(false) {}
...
bool MSKinectDevice1::available() const { return gotDepth; }

int MSKinectDevice1::update() { return 0; }

void MSKinectDevice1::setDepthBuffer() { gotDepth = true; }
